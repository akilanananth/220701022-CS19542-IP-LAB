...
public class NewServlet extends HttpServlet {
    ...
    private String[] studentNames = {
        ...
        "Zane","Kurosaki", "Kuchiki", "Inoue", "Sado", "Ishida", "Urahara", "Shihoin", "Abarai", "Hitsugaya", "Matsumoto", "Zaraki", "Kusajishi", "Soi Fon", "Kyoraku",
        "Ukitake", "Yamamoto", "Kurotsuchi", "Aizen", "Hinamori", 
    "Ichimaru", "Tosen", "Ulquiora", 
    "Grimmjow", "Harribel", "Starrk", 
    "Louisenbairn", "Gilga", "Tu", 
    "Zangetsu", "Yhwach", "Haschwalth", 
    "Bazz-B", "Nodt", "Basterbine", "Arisawa"
    };
